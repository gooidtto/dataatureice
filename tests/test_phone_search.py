...
def _row(rid,date,model,price,condition='开机屏好'):
    r={k:'' for k in mod.FIELDS};r.update(record_id=rid,data_date=date,category='手机',subtype='',brand='Realme',series='X系列',model=model,condition=condition,price=str(price),unit='元',verified='1');return r
