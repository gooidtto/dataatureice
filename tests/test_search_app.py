...
def row(**kw):
 r={k:'' for k in mod.FIELDS};r.update({'data_date':'2026-08-31','category':'phone','subtype':'device','brand':'A','series':'S','model':'M','condition':'好','price':'100','unit':'CNY/台','verified':'1'});r.update(kw);return r
