...
p,rows=load('2026-07-10');img='手机屏幕.jpg';path='数码网报价单-0710更新/手机配件/'+img
...
# 0710 domestic phone-camera image: three rows are fully legible.
p,rows=load('2026-07-10');img='手机摄像头.jpg';path='数码网报价单-0710更新/手机配件/'+img
for model,price in [('国产单头',0.2),('国产后置双头',0.5),('国产后置三头',1)]: add(rows,'2026-07-10','手机配件','手机摄像头','国产','摄像头',model,'点数',price,'元/个',img,path)
write('2026-07-10',p,rows)

# 0710 scrap-phone-parts image: all numeric rows are legible; slash rows are skipped.
p,rows=load('2026-07-10');img='废手机主板.jpg';path='数码网报价单-0710更新/手机配件/'+img
...
# 0710 手机配件.jpg is the same readable table as 废手机主板.jpg; register its source separately without duplicating content rows.
p,rows=load('2026-07-10');img='手机配件.jpg';path='数码网报价单-0710更新/手机配件/'+img
write('2026-07-10',p,rows)
