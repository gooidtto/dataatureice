...
The uploaded `0705` and `0710` image batches are processed by staged materializers `tools/materialize_2026_07.py`, `tools/materialize_2026_07_safe.py`, `tools/materialize_2026_07_extra.py`, `tools/materialize_2026_07_reviewed.py`, `tools/materialize_2026_07_reviewed2.py`, `tools/materialize_2026_07_reviewed3.py`, `tools/materialize_2026_07_reviewed4.py`, `tools/materialize_2026_07_reviewed5.py`, `tools/materialize_2026_07_reviewed6.py`, `tools/materialize_2026_07_reviewed7.py` and `tools/materialize_2026_07_reviewed8.py`. Only clearly readable facts are written; uncertain entries are skipped rather than guessed.

Current expected verified structured subset after the eighth pass: **363 rows for 2026-07-05 and 1,069 rows for 2026-07-10, 1,432 rows total**. Source-image paths, SHA-256 and verification metadata are merged into `source_image_manifest.csv` during CI.

The two uploaded ZIPs contain 63 JPG images. The current pass has reviewed/structured **52 images**, with **11 images remaining for continued identification**. The remaining images are not treated as complete until their readable facts are extracted or they are explicitly marked as unreadable/skipped.
