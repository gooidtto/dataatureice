...
Current expected verified structured subset after the ninth pass: **363 rows for 2026-07-05 and 1,091 rows for 2026-07-10, 1,454 rows total**. Source-image paths, SHA-256 and verification metadata are merged into `source_image_manifest.csv` during CI.

The two uploaded ZIPs contain 63 JPG images. The current pass has reviewed/structured **56 images**, with **7 images remaining for continued identification**. The remaining images are not treated as complete until their readable facts are extracted or they are explicitly marked as unreadable/skipped.
